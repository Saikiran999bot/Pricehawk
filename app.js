...
const CONFIG = {
  ...
  BREVO_SENDER_EMAIL: 'alerts@yourdomain.com',   // ← MUST be verified in Brevo dashboard
...
╚══════════════════════════════════════════════════╝
  ...
  Supabase : ${process.env.SUPABASE_URL.slice(0,40)}...
  Gemini   : ${geminiModel ? '✅ Connected' : '⚠️  Not configured (math fallback active)'}
  Email    : ${process.env.BREVO_API_KEY.startsWith('xkeysib-xxx') ? '⚠️  BREVO_API_KEY not set' : '✅ Brevo ready — ' + process.env.BREVO_SENDER_EMAIL}
